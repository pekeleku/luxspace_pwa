...
import CircleNotif from "../components/CircleNotif";
...
async function subscribe() {
  const key =
    "BDb1evsEOaSqwuc6iaq17_wx3SLzr7IXxlT5ggmD_8MUyA2fWPG-iB_lf_FS5xnCNwwUxRKHcvTxECDqr420vJs";
  try {
                ...
                <li className="ml-6">
                  ...
                  >
                    ...
                    >
                      ...
                      {cart && cart.length > 0 && <CircleNotif />}
                    </svg>
                  </Link>
                </li>
              </ul>
